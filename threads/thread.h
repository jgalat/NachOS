...
class Thread {
  ...
  public:
    Thread(const char* debugName, int _priority);	// initialize a Thread 
    ...
    int GetEffPriority() { return effPriority; }
    void SetEffPriority(int _priority) { effPriority = _priority; }
    void RestorePriority() { effPriority = origPriority; }
       
    void SetExitStatus(int es) { exitStatus = es; }
...
// while executing kernel code.
    ...
    int fd;
    List<OpenFile*> *openFiles; // Key  == FD
