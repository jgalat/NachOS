...
// 2007, Jose Miguel Santos Espino
    ...
    threadList = new ThreadList(); // practica 3
    sConsole = new SynchConsole(NULL, NULL);
    
#ifndef VM
    bmMemory = new BitMap(NumPhysPages);
#else // VM
    //cmMemory = new CoreMap(NumPhysPages, "FIFO"); // Strat FIFO
    //cmMemory = new CoreMap(NumPhysPages, "LRU"); // Strat LRU
    cmMemory = new CoreMap(NumPhysPages, "ESC"); // Strat LRU
#endif
...
// 2007, Jose Miguel Santos Espino
    ...
    delete machine;
    //delete threadList;
    //delete sConsole; /* ASSERT FAIL en los locks.
    //delete bmMemory;
#endif
